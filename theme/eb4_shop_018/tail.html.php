                            ...
                            <div class="row g-0">
                                <div class="col-md-6 col-b-r-1">
                                    <div class="footer-top-box footer-top-customer">
                                        ...
                                        <div class="footer-btn" ><a style="font-family: Pretendard-Bold,serif" href="mailto:<?php echo $bizinfo['bi_company_infomail']; ?>"><i class="far fa-envelope"></i> &nbsp; <?php echo $bizinfo['bi_company_infomail']; ?></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
