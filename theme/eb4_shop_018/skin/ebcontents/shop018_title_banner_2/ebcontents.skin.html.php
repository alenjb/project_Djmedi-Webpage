...
<div class="position-relative <?php if ($ec_master['ec_state'] == '2') { ?>eb-hidden-space<?php } ?>">
    <div class="adm-edit-btn btn-edit-mode" style="top:10px;text-align:center">
        <div class="btn-group">
            ...
            1. 컨텐츠 마스터 제목 : shop018_title_banner_2<br>
            2. 스킨선택 : shop018_title_banner_2<br>
...
<style>
.ebcontents-title-banner-2 {position:relative}
.ebcontents-title-banner-2 .item {position:relativep}
/* 아이템 */
.ebcontents-title-banner-2 .item {display:block;position: relative;}
.ebcontents-title-banner-2 .item img {max-width:100%;height:auto}
.ebcontents-title-banner-2 .item .item-content {position: absolute;top: 20px;left: 0;width: 100%;padding:0 15px;color:var(--white-color);}
.ebcontents-title-banner-2 .item .item-content h4 {margin-bottom:5px;font-size:var(--h2-font-size);}
.ebcontents-title-banner-2 .item .item-content h5 {line-height:1.5em;font-size:var(--small-font-size);}
.ebcontents-title-banner-2 .item .btn-more {position: absolute;bottom: 20px;left: 0;width: 100%;padding:0 15px;}
@media (max-width:991px){
	 .ebcontents-title-banner-2 .item .item-content h4 {font-size:var(--h1-font-size);}
	 .ebcontents-title-banner-2 .item .item-content h5 {font-size:var(--normal-font-size);}
}
@media (max-width:575px){
	 .ebcontents-title-banner-2 .item .item-content h5 {display:none;}
}
@media (min-width:992px){
	 .ebcontents-title-banner-2 .item .item-image {height: 427px; background-repeat: no-repeat; background-size: cover;background-position: center;}
	 .ebcontents-title-banner-2 .item .item-image img {display:none;}
	 .ebcontents-title-banner-2 .item .btn-more {text-align: right;}
}
@media (min-width:1200px){
	 .ebcontents-title-banner-2 .item .item-image {height: 400px;}
}
@media (min-width:1400px){
	 .ebcontents-title-banner-2 .item .item-image {height: 434px;}
}
</style>
<div class="ebcontents ebcontents-title-banner-2">
    <?php /* ebcontents item */?>
    <div class="ebcontents-title-banner-2-inner">
