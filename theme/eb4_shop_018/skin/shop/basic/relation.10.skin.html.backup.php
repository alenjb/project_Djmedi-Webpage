...
/* 컨트롤 좌우 */
.relation-10 .splide__arrow--next, .relation-10 .splide__arrow--prev {top:-30px;width:30px;height:30px;background:none;border:2px solid #333;border-radius:0;-webkit-transition: all .3s ease;-moz-transition: all .3s ease;-o-transition: all .3s ease;-ms-transition: all .3s ease;transition: all .3s ease}
.relation-10 .splide__arrow--next {right:6px;z-index:1}
.relation-10 .splide__arrow--prev {left:6px;z-index:1}
.relation-10 .splide__arrow--next:hover, .relation-10 .splide__arrow--prev:hover {background:#333}
.relation-10 .splide__arrow--next:before, .relation-10 .splide__arrow--prev:before {content:"";display:block;opacity:1;position:absolute;top:50%;width:12px;height:12px;margin-top:-6px;-webkit-transform:rotate(45deg);-moz-transform:rotate(45deg);-o-transform:rotate(45deg);-ms-transform:rotate(45deg);transform:rotate(45deg);transition:.3s}
.relation-10 .splide__arrow--next:before {right:10px;border-right:2px solid #333;border-top:2px solid #333}
.relation-10 .splide__arrow--prev:before {left:10px;border-left:2px solid #333;border-bottom:2px solid #333}
.relation-10 .splide__arrow--next:hover:before, .relation-10 .splide__arrow--prev:hover:before {border-color:#fff}
...
<div class="relation-10  splide">
    ...
    <div class="relation-10-in splide__track">
		<ul class="splide__list">
	        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
	        <li class="splide__slide item-relation-10">
