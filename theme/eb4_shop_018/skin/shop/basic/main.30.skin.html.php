...
.product-main-30 .item-main-30 {position:relative;height:100%;background-color:var(--white-color);border:1px solid var(--border-color-light);}
...
.product-main-30 .product-img-in .discount-percent {position:absolute;top:-40px;left:-40px;width:80px;height:80px;padding-top:57px;text-align:center;background:var(--primary-color-dark);color:var(--white-color);font-style:italic;font-size:.75rem;-webkit-transform:rotate(-45deg);-moz-transform:rotate(-45deg);transform:rotate(-45deg)}
/* 상품 유형 */
...
.product-main-30 .product-description .product-description-in {position:relative;overflow:hidden;z-index:1;padding:15px}
.product-main-30 .product-description .product-info {position:relative;margin:5px 0;line-height:1.2em;font-size:var(--smaller-font-size);color:var(--text-color-light);word-break:keep-all;}
.product-main-30 .product-description .product-name {position:relative;margin:5px 0 15px;}
.product-main-30 .product-description .product-name a {display:block;line-height:1.4em;font-size:var(--normal-font-size);color:var(--text-color);word-break:keep-all;}
.product-main-30 .product-description .product-name a:hover {text-decoration:underline}
.product-main-30 .product-description .product-price {display:flex;align-items:center;flex-wrap:wrap;}
.product-main-30 .product-description .title-price {font-size:var(--small-font-size);font-weight:bold;}
.product-main-30 .product-description .line-through {font-size:var(--small-font-size);color:var(--border-color);text-decoration:line-through;font-weight:normal}
.product-main-30 .product-description .product-price svg.arrow-icon {width:auto;height:18px;margin:0 5px;}
/* 별점 */
...
.product-main-30 .product-ratings {display:flex;}
.product-main-30 .product-ratings li {padding:0}
...
/* 소셜링크 */
.product-main-30 .product-description .product-sns {margin-top:10px}
.product-main-30 .product-description .product-sns ul {display:flex;}
.product-main-30 .product-description .product-sns ul li {margin-right:2px}
.product-main-30 .product-description .product-sns ul li:last-child {margin-bottom:0}
.product-main-30 .product-description .product-sns ul li a {display:inline-block;width:26px;height:26px;line-height:26px;text-align:center;background:#c5c5c5;color:#fff;font-size:12px}
.product-main-30 .product-description .product-sns ul .s-wish a:hover {background:#cc2300}
.product-main-30 .product-description .product-sns ul .s-facebook a:hover {background:#405892}
.product-main-30 .product-description .product-sns ul .s-twitter a:hover {background:#4CA0EB}

@media (max-width:767px) {
    .product-main-30 .product-description .title-price, .product-main-30 .product-description .line-through {font-size:var(--small-font-size);}
}
...
@media (min-width:1200px) {
    .product-main-30 .col-lg-3 {width:20%}
}
</style>

<div class="product-main-30 row g-2 g-lg-4">
