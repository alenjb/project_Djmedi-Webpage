...
<style>
.product-main-50 {display:none;position:relative}
.product-main-50 .item-main-50 {position:relative;outline:none}
.product-main-50 .item-main-50-in {display:flex;position:relative;;background-color:var(--white-color);border:1px solid var(--border-color-light);}
/* 이미지 */
.product-main-50 .product-img {position:relative;overflow:hidden;flex:0 0 auto;width:35%;}
...
.product-main-50 .product-img-in .discount-percent {position:absolute;top:-40px;left:-40px;width:80px;height:80px;padding-top:57px;text-align:center;background:var(--primary-color-dark);color:var(--white-color);font-style:italic;font-size:.75rem;-webkit-transform:rotate(-45deg);-moz-transform:rotate(-45deg);transform:rotate(-45deg)}
/* 상품 유형 */
...
.product-main-50 .rgba-banner {height:14px;width:50px;line-height:14px;color:#fff;font-size:10px;text-align:center;font-weight:normal;position:relative;text-transform:uppercase;margin-bottom:1px}
/* 상품정보 */
.product-main-50 .product-description {position:relative;overflow:hidden;flex:0 0 auto;width:65%}
.product-main-50 .product-description .product-description-in {position:relative;bottom:0;overflow:hidden;z-index:1;padding:15px}
.product-main-50 .product-description .product-info {position:relative;line-height:1.2em;font-size:var(--smaller-font-size);color:var(--text-color-light);}
.product-main-50 .product-description .product-name {position:relative;margin:5px 0 15px}
.product-main-50 .product-description .product-name a {display:block;line-height:1.4em;font-size:var(--normal-font-size);color:var(--text-color);}
.product-main-50 .product-description .product-name a:hover {text-decoration:underline}
.product-main-50 .product-description .product-price {display:flex;align-items:center;flex-wrap:wrap;}
.product-main-50 .product-description .title-price {font-size:var(--normal-font-size);font-weight:bold;}
.product-main-50 .product-description .line-through {font-size:var(--normal-font-size);color:var(--border-color);text-decoration:line-through;font-weight:normal}
.product-main-50 .product-description .product-price svg.arrow-icon {width:auto;height:18px;margin:0 5px;}
/* 소셜링크 */
.product-main-50 .product-description .product-sns {margin-top:10px}
.product-main-50 .product-description .product-sns ul {display:flex;}
.product-main-50 .product-description .product-sns ul li {margin-right:2px}
...
.product-main-50 .product-description .product-sns ul .s-wish a:hover {background:#cc2300}
.product-main-50 .product-description .product-sns ul .s-facebook a:hover {background:#405892}
.product-main-50 .product-description .product-sns ul .s-twitter a:hover {background:#4CA0EB}
/* 별점 */
...
.product-main-50 .product-ratings {display:flex;}
.product-main-50 .product-ratings li {padding:0}
.product-main-50 .product-ratings li .rating {color:#959595;line-height:normal;font-size:11px;vertical-align:top;}
.product-main-50 .product-ratings li .rating-selected {color:#FF4848;font-size:11px;vertical-align:top;}
/* 컨트롤 좌우 */
.product-main-50 .splide__arrow--next,
.product-main-50 .splide__arrow--prev {opacity: 0;width: 40px;height: 40px; background: rgba(0,0,0,.6);-webkit-transition: all 0.3s linear;-moz-transition: all 0.3s linear;-o-transition: all 0.3s linear;-ms-transition: all 0.3s linear;transition: all 0.3s linear;border-radius: 50% !important;}
.product-main-50 .splide__arrow--next:hover,
.product-main-50 .splide__arrow--prev:hover {background: rgba(0,0,0,.8);}
.product-main-50 .splide__arrow--next {right: 0;z-index: 1}
.product-main-50 .splide__arrow--prev {left: 0;z-index: 1}
.product-main-50:hover .splide__arrow--next {right: 0.5rem;opacity: 1;}
.product-main-50:hover .splide__arrow--prev {left: 0.5rem;opacity: 1;}
.product-main-50 .splide__arrow--next:before,
.product-main-50 .splide__arrow--prev:before {content: "";display: block;position: absolute;top: 50%;width: 14px;height: 14px;margin-top: -7px;-webkit-transform: rotate(45deg);-moz-transform: rotate(45deg);-o-transform: rotate(45deg);-ms-transform: rotate(45deg);transform: rotate(45deg);transition: all 0.3s linear;}
.product-main-50 .splide__arrow--next:before {right: 15px;border-right: 1px solid #eee;border-top: 1px solid #eee;}
.product-main-50 .splide__arrow--prev:before {left: 15px;border-left: 1px solid #eee;border-bottom: 1px solid #eee;}

.notice-mo {display:none}
@media (max-width:991px) {
    .product-main-50 .splide__arrows {display: none}
...
@media (max-width:767px) {
    .product-main-50 .product-description .product-info {display: none;}
    .product-main-50 .product-description .title-price, .product-main-50 .product-description .line-through {font-size:var(--small-font-size);}
}
</style>

<div class="product-main-50 splide">
	<?php /* 좌우 버튼 */ ?>
	...
	<div class="product-main-50-in splide__track">
	    <ul class="splide__list">
			<?php for ($i=0; $i<count((array)$list); $i++) { ?>
			<li class="item-main-50 splide__slide">
...
<script>
	$(window).load(function(){
		$('.product-main-50').show();
		new Splide( '.product-main-50', {
			type : 'loop',
			perPage: 2,
			perMove: 1,
			gap: '1.5rem',
