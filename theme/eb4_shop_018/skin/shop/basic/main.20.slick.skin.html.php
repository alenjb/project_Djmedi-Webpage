...
.product-main-20 .product-img-in .discount-percent {position:absolute;top:-20px;left:-20px;width:80px;height:80px;padding-top:57px;text-align:center;background:var(--primary-color-dark);color:var(--white-color);font-style:italic;font-size:.75rem;-webkit-transform:rotate(-45deg);-moz-transform:rotate(-45deg);transform:rotate(-45deg)}
/* 상품 유형 */
...
.product-main-20 .product-description .product-price {display:flex;align-items:center;}
...
/* 컨트롤 좌우 */
.product-main-20 .slick-next,
.product-main-20 .slick-prev {opacity: 0;width: 40px;height: 40px;background: rgba(0,0,0,.6);-webkit-transition: all 0.3s linear;-moz-transition: all 0.3s linear;-o-transition: all 0.3s linear;-ms-transition: all 0.3s linear;transition: all 0.3s linear;border-radius: 50% !important;}
.product-main-20 .slick-next:hover,
.product-main-20 .slick-prev:hover {background: rgba(0,0,0,.8);}
.product-main-20 .slick-next {right: 0;z-index: 1}
.product-main-20 .slick-prev {left: 0;z-index: 1}
.product-main-20 :hover .slick-next {right: 25px;opacity: 1;}
.product-main-20 :hover .slick-prev {left: 25px;opacity: 1;}
.product-main-20 .slick-next:before,
.product-main-20 .slick-prev:before {content: "";display: block;position: absolute;top: 50%;width: 14px;height: 14px;margin-top: -7px;-webkit-transform: rotate(45deg);-moz-transform: rotate(45deg);-o-transform: rotate(45deg);-ms-transform: rotate(45deg);transform: rotate(45deg);transition: all 0.3s linear;}
.product-main-20 .slick-next:before {right: 15px;border-right: 1px solid #eee;border-top: 1px solid #eee}
.product-main-20 .slick-prev:before {left: 15px;border-left: 1px solid #eee;border-bottom: 1px solid #eee}
