...
<style>
.product-main-40 {display:none;position:relative}
.product-main-40 .item-main-40 {position:relative;outline:none}
.product-main-40 .item-main-40-in {position:relative;;height:100%;background-color:var(--body-color-deep);border:1px solid var(--border-color-light);}

/* 이미지 */
.product-main-40 .product-img {position:relative;overflow:hidden;}
...
.product-main-40 .product-img-in .discount-percent {position:absolute;top:-40px;left:-40px;width:80px;height:80px;padding-top:57px;text-align:center;background:var(--primary-color-dark);color:var(--white-color);font-style:italic;font-size:.75rem;-webkit-transform:rotate(-45deg);-moz-transform:rotate(-45deg);transform:rotate(-45deg)}
/* 상품 유형 */
...
.product-main-40 .product-description .product-description-in {position:relative;overflow:hidden;z-index:1;padding:15px}
.product-main-40 .product-description .product-info {position:relative;margin:5px 0;line-height:1.2em;font-size:var(--smaller-font-size);color:var(--text-color-light);word-break:keep-all;}
.product-main-40 .product-description .product-name {position:relative;margin:5px 0 15px}
.product-main-40 .product-description .product-name a {display:block;line-height:1.4em;font-size:var(--normal-font-size);color:var(--text-color);word-break:keep-all;}
.product-main-40 .product-description .product-name a:hover {text-decoration:underline}
.product-main-40 .product-description .product-price {display:flex;align-items:center;flex-wrap:wrap;}
.product-main-40 .product-description .title-price {font-size:var(--small-font-size);font-weight:bold;}
.product-main-40 .product-description .line-through {font-size:var(--small-font-size);color:var(--border-color);text-decoration:line-through;font-weight:normal}
.product-main-40 .product-description .product-price svg.arrow-icon {width:auto;height:18px;margin:0 5px;}
/* 별점 */
...
.product-main-40 .product-ratings {display:flex;}
.product-main-40 .product-ratings li {padding:0}
...
/* 소셜링크 */
.product-main-40 .product-description .product-sns {margin-top:10px}
.product-main-40 .product-description .product-sns ul {display:flex;}
.product-main-40 .product-description .product-sns ul li {margin-right:2px}
.product-main-40 .product-description .product-sns ul li:last-child {margin-bottom:0}
.product-main-40 .product-description .product-sns ul li a {display:inline-block;width:26px;height:26px;line-height:26px;text-align:center;background:#c5c5c5;color:#fff;font-size:12px}
.product-main-40 .product-description .product-sns ul .s-wish a:hover {background:#cc2300}
.product-main-40 .product-description .product-sns ul .s-facebook a:hover {background:#405892}
.product-main-40 .product-description .product-sns ul .s-twitter a:hover {background:#4CA0EB}

/* 컨트롤 좌우 */
.product-main-40 .splide__arrow--next,
.product-main-40 .splide__arrow--prev {opacity: 0;width: 40px;height: 40px;background: rgba(0,0,0,.6);-webkit-transition: all 0.3s linear;-moz-transition: all 0.3s linear;-o-transition: all 0.3s linear;-ms-transition: all 0.3s linear;transition: all 0.3s linear;border-radius: 50% !important;}
.product-main-40 .splide__arrow--next:hover,
.product-main-40 .splide__arrow--prev:hover {background: rgba(0,0,0,.8);}
.product-main-40 .splide__arrow--next {right: 0;z-index: 1;}
.product-main-40 .splide__arrow--prev {left: 0;z-index: 1;}
.product-main-40:hover .splide__arrow--next {right: 0.5rem;opacity: 1;}
.product-main-40:hover .splide__arrow--prev {left: 0.5rem;opacity: 1;}
.product-main-40 .splide__arrow--next:before,
.product-main-40 .splide__arrow--prev:before {content: "";display: block;position: absolute;top: 50%;width: 14px;height: 14px;margin-top: -7px;-webkit-transform: rotate(45deg);-moz-transform: rotate(45deg);-o-transform: rotate(45deg);-ms-transform: rotate(45deg);transform: rotate(45deg);transition: all 0.3s linear;}
.product-main-40 .splide__arrow--next:before {right: 15px;border-right: 1px solid #eee;border-top: 1px solid #eee;}
.product-main-40 .splide__arrow--prev:before {left: 15px;border-left: 1px solid #eee;border-bottom: 1px solid #eee;}

.notice-mo {display:none}
@media (max-width:991px) {
    .product-main-40 .splide__arrows {display: none}
...
@media (max-width:767px) {
    .product-main-40 .product-description .title-price, .product-main-40 .product-description .line-through {font-size:var(--small-font-size);}
}
</style>

<div class="product-main-40 splide">
	<?php /* 좌우 버튼 */ ?>
	...
	<div class="product-main-40-in splide__track">
	    <ul class="splide__list">
			<?php for ($i=0; $i<count((array)$list); $i++) { ?>
			<li class="item-main-40 splide__slide">
...
<script>
	$(window).load(function(){
		$('.product-main-40').show();
		new Splide( '.product-main-40', {
			type : 'loop',
			perPage: 4,
			perMove: 1,
			gap: '1.5rem',
