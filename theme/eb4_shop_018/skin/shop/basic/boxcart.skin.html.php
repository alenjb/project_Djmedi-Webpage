...
<div id="sbsk" class="op-area">
    ...
    <?php if ($ct_count > 0) { ?>
    <button type="submit" class="btn-e btn-e-sm btn-e-block btn-e-crimson m-b-5">바로구매</button>
    <?php } ?>
    <a href="<?php echo G5_SHOP_URL; ?>/cart.php" class="btn-e btn-e-sm btn-e-block btn-e-dark btn-e-brd">장바구니 바로가기</a>
    </form>
</div>