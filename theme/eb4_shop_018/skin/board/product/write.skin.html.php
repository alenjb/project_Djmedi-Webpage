<?php
/**
 * skin file : /theme/THEME_NAME/skin/board/product/write.skin.html.php
 */
    ...
    <section>
        <div class="row">
	        <div class="col col-6 md-m-b-10">
                <label for="wr_6" class="label"><?php echo $board['bo_6_subj']; ?></label>
                <label class="input m-b-10">
                    <input type="text" name="wr_6" id="wr_6" value="<?php echo $wr_6; ?>">
                </label>
	        </div>
	        <div class="col col-6 md-m-b-10">
                <label for="wr_7" class="label"><?php echo $board['bo_7_subj']; ?></label>
                <label class="input m-b-10">
                    <input type="text" name="wr_7" id="wr_7" value="<?php echo $wr_7; ?>">
                </label>
	        </div>
	        <div class="col col-6 md-m-b-10">
                <label for="wr_8" class="label"><?php echo $board['bo_8_subj']; ?></label>
                <label class="input m-b-10">
                    <input type="text" name="wr_8" id="wr_8" value="<?php echo $wr_8; ?>">
                </label>
	        </div>
	        <div class="col col-6 md-m-b-10">
                <label for="wr_9" class="label"><?php echo $board['bo_9_subj']; ?></label>
                <label class="input m-b-10">
        ...
        <?php for ($i=0; $i<$wf_cnt; $i++) { ?>
            <div class="col col-6">
                <label class="label margin-top-5">
                    이미지 <span class="color-red"><?php echo $i+1; ?></span> 업로드
                    <?php if($i == 0) { ?>
                    <span class="margin-left-5 color-grey font-size-11 font-normal">- 목록 대표이미지</span>
                    <?php } ?>
                </label>
